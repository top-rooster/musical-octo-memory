...
Examples include `Player`, `Anchored`, `Powered`, `Cutting Tool`, `Dressed`, `Clean` as a Marker on fabric, `Health 100`, `Progress 42`, `Durability 80`, `Spoilage 63`, and `Clean 70` as a Value on a wound.
